...
export const RiskScoreDesc = "A count of the number of times the Risk Index exceeds a safe value. The higher the number, the higher the risk of injury.";
...
export const getDescription = activeTab => {
    switch (activeTab) {
        ...
        case "Risk Frequency":
            return "A count of the number of times the Risk Index exceeds a safe value. The higher the number, the higher the risk of injury.";
        case "Speed Score":
